...
var Data = exports.Data = /*#__PURE__*/function () {
  ...
  return _createClass(Data, null, [{
    key: "saveTask",
    value: function saveTask(taskName) {
      var task = {
        text: taskName,
    ...
    value: function restoreTasks() {
      ...
      this.done = localStorage.getItem("done") ? JSON.parse(localStorage.getItem("done")) : [{
    ...
    key: "addTaskToDone",
    value: function addTaskToDone(taskId) {
      var _this = this;
      this.todo.forEach(function (element, index) {
        if (element.id === taskId) {
          _this.done.push(element);
          _this.todo.splice(index, 1);
          _this.saveToLocalStorage();
        }
      });
    }
  }, {
    key: "removeTaskFromDone",
    value: function removeTaskFromDone(taskId) {
      var _this2 = this;
      this.done.forEach(function (element, index) {
        if (element.id === taskId) {
          _this2.todo.push(element);
          _this2.done.splice(index, 1);
    ...
    key: "removeTask",
    value: function removeTask(taskId, taskStat) {
      var _this3 = this;
      if (taskStat === "todo") {
        this.todo.forEach(function (element, index) {
          if (element.id === taskId) {
            _this3.todo.splice(index, 1);
    ...
    key: "findTask",
    value: function findTask(taskWord) {
      var todo = [];
      var done = [];
      this.restoreTasks();
      var todoLength = this.todo.length;
      var doneLength = this.done.length;
      var maxLength = todoLength > doneLength ? todoLength : doneLength;
      for (var i = 0; i < maxLength; i++) {
        ...
        if (i < doneLength) {
          var _element = this.done[i];
          if (_element.text.includes(taskWord)) {
            done.push(_element);
          }
        }
      }
...
_defineProperty(Data, "todo", []);
_defineProperty(Data, "done", []);
...
function addTask() {
  var taskInput = document.querySelector(".js-add-task-form");
  if (taskInput) {
    taskInput.addEventListener("submit", function (e) {
      e.preventDefault();
      var taskName = document.querySelector(".js-task-input").value;
      document.querySelector(".js-task-input").value = "";
      if (taskName === "") return;
      _data["default"].saveTask(taskName);
      renderTodoList(_data["default"]);
    });
  }
}
function compliteTask() {
  document.querySelectorAll(".js-check-box").forEach(function (checkBox) {
    checkBox.addEventListener("click", function (event) {
      var reTask = false;
      var taskId = checkBox.dataset.taskId;
      var container = event.target.closest(".task");
      ...
      if (!reTask) {
        _data["default"].addTaskToDone(taskId);
        renderTodoList(_data["default"]);
      } else {
        _data["default"].removeTaskFromDone(taskId);
        renderTodoList(_data["default"]);
      }
    });
  });
...
function renderTasks(todoTasks) {
  ...
  todoTasks.forEach(function (todo) {
    todoListHTML += "\n      <div class=\"task\">\n        <div class=\"check-box js-check-box\" data-task-id=\"".concat(todo.id, "\"></div>\n        <div class=\"task-name-container\" >\n          <p class=\"task-name\">").concat(todo.text, "</p>\n        </div>\n        <button class=\"delete-button js-delete-button\" data-task-id=\"").concat(todo.id, "\" data-task-stat=\"todo\">\n          <img src=\"./src/icones/garbage.svg\" alt=\"delete button\" />\n        </button>\n      </div>\n    ");
  });
  return todoListHTML;
}
function renderDoneTasks(doneTasks) {
  ...
  doneTasks.forEach(function (todo) {
    todoListHTML += "\n      <div class=\"task task-done\">\n        <div class=\"check-box js-check-box\" data-task-id=\"".concat(todo.id, "\"></div>\n        <div class=\"task-name-container\" >\n          <p class=\"task-name\">").concat(todo.text, "</p>\n        </div>\n        <button class=\"delete-button js-delete-button\" data-task-id=\"").concat(todo.id, "\" data-task-stat=\"done\">\n          <img src=\"./src/icones/garbage.svg\" alt=\"delete button\" />\n        </button>\n      </div>\n    ");
  });
  return todoListHTML;
}
function deleteListener() {
  document.querySelectorAll(".js-delete-button").forEach(function (button) {
    button.addEventListener("click", function () {
      _data["default"].removeTask(button.dataset.taskId, button.dataset.taskStat);
      renderTodoList(_data["default"]);
    });
  });
}
function changeFeature() {
  var changeFeatureButton = document.querySelector(".js-change-feature-button");
  changeFeatureButton.addEventListener("click", function () {
    var mainPart = document.querySelector(".js-main-part");
    var toSearchStage = mainPart.querySelector(".js-add-task-form");
    if (toSearchStage) {
      ...
      _mainHtml += mainPart.innerHTML;
      mainPart.innerHTML = _mainHtml;
      renderTodoList(_data["default"]);
    }
  });
}
function searchButtonListener() {
  ...
  if (searchButton) {
    searchButton.addEventListener("click", function (e) {
      ...
      searchInput.value = "";
      var resoults = _data["default"].findTask(searchValue);
